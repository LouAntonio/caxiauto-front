...
/**
 * Skeleton for parts detail page (DetalhesPecas).
				...
				<div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
					...
					<div className="lg:col-span-2 space-y-6">
						...
						<div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
							<div className="relative h-96 bg-gradient-to-br from-gray-200 to-gray-300 animate-pulse">
								...
								<div className="absolute top-4 left-4 flex gap-2">
									<div className="w-16 h-6 bg-gray-400 rounded-full opacity-60" />
									<div className="w-14 h-6 bg-gray-400 rounded-full opacity-60" />
								</div>
							...
							<div className="grid grid-cols-2 md:grid-cols-4 gap-4">
								{[1, 2, 3, 4].map((i) => (
									<div key={i} className="flex flex-col items-center p-4 bg-gradient-to-br from-gray-50 to-indigo-50/30 rounded-xl animate-pulse">
										...
										<div className="w-14 h-3 bg-gray-200 rounded mb-1" />
										<div className="w-16 h-4 bg-gray-300 rounded text-sm" />
									</div>
								))}
							</div>
						</div>
						...
						<div className="bg-white rounded-2xl shadow-xl p-6 border border-gray-100">
							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-3">
								{[1, 2, 3, 4].map((i) => (
									<div key={i} className="flex items-center gap-2 p-3 bg-gray-50 rounded-lg animate-pulse">
						...
						<div className="bg-white rounded-2xl shadow-xl p-6 border border-gray-100">
							...
							<div className="flex items-center gap-4 p-4 bg-gradient-to-r from-gray-50 to-indigo-50/30 rounded-xl animate-pulse">
								<div className="w-14 h-14 bg-indigo-200 rounded-full" />
					...
					<div className="lg:col-span-1">
						<div className="sticky top-24 space-y-4">
							{/* Price card skeleton */}
							<div className="bg-white rounded-2xl shadow-xl p-6 border border-gray-100">
								<div className="h-5 w-14 bg-gray-200 rounded animate-pulse mb-3" />
								<div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-xl p-5 mb-6 animate-pulse">
									<div className="h-9 w-32 bg-gray-300 rounded mb-1" />
								...
								{/* Total estimate skeleton */}
								<div className="bg-gray-50 rounded-xl p-4 mb-4 animate-pulse">
							...
							<div className="bg-white rounded-2xl shadow-xl p-6 border border-gray-100">
								...
								<div className="space-y-3">
									{[1, 2, 3, 4].map((i) => (
										<div key={i} className="flex justify-between items-center py-2 border-b border-gray-100 animate-pulse">
							...
							<div className="bg-gradient-to-br from-indigo-50 to-blue-50 border-2 border-indigo-200 rounded-xl p-5 shadow-lg animate-pulse">
								<div className="h-6 w-32 bg-indigo-200 rounded animate-pulse mb-4" />
								<div className="space-y-3">
									{[1, 2, 3].map((i) => (
							...
							<div className="bg-gradient-to-br from-indigo-600 via-indigo-700 to-purple-700 rounded-2xl shadow-xl p-6 border border-indigo-400/20">
								<div className="h-5 w-32 bg-indigo-400/40 rounded animate-pulse mb-4" />
								<div className="h-4 w-full bg-indigo-400/30 rounded animate-pulse mb-4" />
								<div className="space-y-3">
									{[1, 2].map((i) => (
										<div key={i} className="flex items-center gap-3 p-3 bg-white/10 rounded-xl animate-pulse">
