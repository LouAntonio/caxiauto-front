			...
			<section className="py-24 px-6 bg-white relative" id="formulario">
				...
				<div className="max-w-5xl mx-auto">
					...
					<div className="bg-gradient-to-br from-white to-blue-50/30 rounded-3xl shadow-[0_8px_30px_rgb(21,76,154,0.12)] p-8 md:p-12 border-2 border-blue-100/50">
						<form onSubmit={handleSubmit} className="space-y-10">{/* Dados do Vendedor */}
							<div>
							...
							<div className="bg-gradient-to-br from-blue-50 to-white p-8 rounded-2xl border-2 border-blue-100">
								...
								<div className="space-y-3 text-sm text-gray-700 max-h-64 overflow-y-auto mb-6 pr-2">
							...
							<div className="text-center pt-6">
								<button
									type="submit"
									className="bg-gradient-to-r from-[#154c9a] to-blue-600 hover:from-[#123a7a] hover:to-blue-700 text-white font-bold py-5 px-12 rounded-full text-lg transition-all duration-300 shadow-lg hover:shadow-2xl transform hover:scale-105"
								>
									REGISTAR A MINHA VIATURA
								</button>
							</div>
						</form>
					</div>
