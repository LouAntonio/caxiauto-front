...
export default function VendaDeAutomoveis() {
	...
	const steps = [
		{
			...
			description: 'Utilize os nossos filtros avançados para pesquisar viaturas por marca, modelo, preço e localização exata.',
			icon: Search,
		},
		{
			number: '02',
			label: 'PASSO',
			title: 'Analise os Detalhes',
			description: 'Consulte fotos de alta qualidade, especificações técnicas completas e o estado real da viatura.',
			icon: Eye,
		},
		{
			number: '03',
			...
			description: 'Entre em contacto com o vendedor ou stand parceiro para tirar dúvidas, agendar visitas ou negociar valores.',
			icon: MessageCircle,
		},
		{
			number: '04',
			label: 'PASSO',
			title: 'Compra Segura',
			description: 'Finalize o negócio com confiança, sabendo que está a tratar com vendedores verificados pela nossa equipa.',
			icon: CheckCircle2,
		}
	];
	...
	const features = [
		{
			icon: Sparkles,
			title: 'Viaturas Novas',
			description: 'Encontre os últimos lançamentos de diversas marcas e modelos, diretamente de concessionários oficiais parceiros.'
		},
		{
			icon: History,
			title: 'Usados de Qualidade',
			description: 'Uma vasta seleção de carros usados e seminovos, inspecionados para garantir fiabilidade e bom estado.'
		},
		{
			icon: ShieldCheck,
			title: 'Anunciantes Verificados',
			description: 'Todos os stands e vendedores particulares passam por um processo de verificação rigoroso para sua segurança.'
		},
		{
			icon: ArrowRightLeft,
			title: 'Comparação Fácil',
			description: 'Ferramentas intuitivas para comparar características, preços e vantagens entre múltiplos veículos lado a lado.'
		},
	];
			...
			<section className="py-24 px-6 bg-[#154c9a] text-white relative overflow-hidden isolate">
				...
				<div className="max-w-4xl mx-auto text-center relative z-10">
					<div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-500/20 border border-blue-400/30 text-blue-100 mb-6 backdrop-blur-sm">
						...
						<span className="font-medium">O seu próximo carro está aqui</span>
					</div>
					<h1 className="text-5xl md:text-7xl font-extrabold mb-8 tracking-tight">
						Compre o Carro Ideal
					</h1>
					<p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
						Novos ou usados. Particulares ou stands. A maior variedade de viaturas com total transparência e segurança.
					</p>
			...
			<section className="py-24 px-6 bg-white relative">
				...
				<div className="max-w-7xl mx-auto">
					<div className="text-center mb-20">
						...
						<h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">O que encontra aqui?</h2>
						<p className="text-xl text-gray-600 max-w-2xl mx-auto">
							Reunimos as melhores ofertas do mercado num único lugar.
						</p>
					</div>
					...
					<div className="mt-20 text-center">
						<Link
							to="/search?type=buy"
							className="inline-flex items-center justify-center px-10 py-5 text-lg font-bold text-white bg-[#154c9a] rounded-full hover:bg-blue-800 transition-colors shadow-xl shadow-blue-900/20 hover:shadow-2xl hover:-translate-y-1 transform duration-200 gap-3"
						>
